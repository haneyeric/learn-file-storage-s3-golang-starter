...
func (cfg *apiConfig) handlerUploadVideo(w http.ResponseWriter, r *http.Request) {
	...
	params := s3.PutObjectInput{Bucket: &cfg.s3Bucket, Key: &filename, Body: processedFile, ContentType: &media}
...
// func processVideoForFastStart2(inputFilePath string) (string, error) {
